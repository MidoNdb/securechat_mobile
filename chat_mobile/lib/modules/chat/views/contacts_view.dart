...
// import 'package:get/get.dart';
// import '../controllers/contacts_controller.dart';
// //import '../controllers/messages_controller.dart'; // ✅ IMPORT AJOUTÉ
...
//             final displayName = (contact['display_name'] ?? 'بدون اسم').toString();
//             final phone = contact['phone_number'] ?? '';
//             final contactUserId = contact['contact_user_id']; // ✅ DOIT EXISTER
...
//                     // ✅ APPEL CORRECT
//                     Get.find<MessagesController>().openOrCreateConversation(
//                       contactUserId: contactUserId,
//                       contactName: displayName,
//                     );
//                   } else {
//                     Get.snackbar('تنبيه', 'هذا المستخدم ليس لديه حساب شات');
//                   }
//                 },
//                 leading: CircleAvatar(
...
//             onPressed: () async {
//               final success = await controller.addContactByPhone(
